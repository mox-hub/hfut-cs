        ...
        <div class="container">
            ...
            <div class="handle-box">
                <el-select v-model="query.mode" placeholder="查询模式" class="handle-select mr10">
                    <el-option key="1" label="读者ID查询" value="id"></el-option>
                </el-select>
            ...
            <el-table :data="lendData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template #default="scope">
                        <el-button v-if="!scope.row.backDate" type="text" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)">归还
                        </el-button>
...
export default {
    ...
    setup() {
        ...
        // 获取表格数据
        const getFormData = () => {
            getDataParam(query,"/lend/getAllLends").then((res) => {
                console.log(res)
        ...
        const handleEdit = (index, row) => {
            ...
            form.lendDate = formatDate(form.lendDate);
            form.backDate = formatDate(Date());
            console.log(Date())
